...
export const INITIAL_BATCHES = [
  { id: 'b1', name: 'Class 7 - Morning', class: '7', timing: '08:00 AM', createdAt: Date.now() },
  { id: 'b2', name: 'Class 8 - Evening', class: '8', timing: '04:00 PM', createdAt: Date.now() },
  { id: 'b3', name: 'Class 9 - Regular', class: '9', timing: '10:00 AM', createdAt: Date.now() }
];
